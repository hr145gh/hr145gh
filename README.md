...
A personal resume website showcasing my background, skills, experience, and projects — all in one place.

## 📁 Repository Contents

| File/Folder | Description |
|---|---|
| `harshitrajpf.netlify.app/` | Main resume website |
| `Harshit_NIT_Allahabad_Resume.pdf` | Downloadable PDF version of my resume |
